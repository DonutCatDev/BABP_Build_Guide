...
## Overview
Assemble one of the front shroud variants for your BABP build. This section covers both the standard railgun shroud and the railgun bipod shroud path.

## Variant Paths
- [Railgun Variant](railgun.md)
- [Bipod Sub-Assembly](bipod-sub-assembly.md)
- [Bipod Variant](bipod.md)
